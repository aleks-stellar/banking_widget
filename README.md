...
- transactions_parser - в модуле реализованы функции:
Функция read_csv_transactions, преобразующая транзакции из CSV-файла
в список словарей.
Функция read_excel_transactions, преобразующая транзакции из EXCEL-файла
в список словарей.
...
значения переменных реальными данными.
6. Проект использует централизованное хранение логов в директории logs
в корне проекта - необходимо создать эту директорию.
