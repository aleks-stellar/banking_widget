...
- utils - в модуле реализованы 2 функции:
1. Функция get_list_operations, возвращающая список словарей с данными 
о финансовых транзакциях из json-файла.
2. Функция get_amount, принимающая на вход транзакцию и возвращающая
